...
public class SombreHeroEntity {
    ...
    public static Villager getEntity(Location loc){
        ...
        trades.get(0).addIngredient(new ItemStack(Material.SCULK, price));
        ...
        trades.get(1).addIngredient(new ItemStack(Material.SCULK_VEIN, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(2).addIngredient(new ItemStack(Material.SCULK_CATALYST, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(3).addIngredient(new ItemStack(Material.SCULK_SENSOR, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(4).addIngredient(new ItemStack(Material.COBWEB, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(5).addIngredient(new ItemStack(Material.ENCHANTED_GOLDEN_APPLE, price));
        ...
        trades.get(6).addIngredient(new ItemStack(Material.DEEPSLATE_BRICKS, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(7).addIngredient(new ItemStack(Material.CANDLE, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(8).addIngredient(new ItemStack(Material.SOUL_LANTERN, price));
        ...
        // random price
        price = (int) (Math.random() * 5) + 1;
        trades.get(9).addIngredient(new ItemStack(Material.POLISHED_DEEPSLATE, price));

        warden.setRecipes(trades);
